...
#
# CUSTOMIZATION:
# - Change branch names if you use different protected branches (e.g., master, develop, production)
# - Adjust the regex patterns if you need to match additional git commands
...
# CUSTOMIZATION: Add/remove protected branch names here
